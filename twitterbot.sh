...
rm shop.png
sleep 15s
curl "http://api2.nitestats.com/v1/shop/image?background=https://raw.githubusercontent.com/kuletxcore/kxc-fortnite-bot/master/media/nitestats.jpg" --output shop.png
cd ..
python app.py
sleep 20s
cd output
